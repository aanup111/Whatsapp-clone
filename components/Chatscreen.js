...
function Chatscreen({ chat, messages }) {
    ...
    // scroll to bottom of page (view) once message is sent
    ...
    const sendMessage = (e) => {
        ...
        e.preventDefault();
        // update last seen when user sends a message
        db.collection('users').doc(user.uid).set({
            lastSeen: firebase.firestore.FieldValue.serverTimestamp(),
        },{ merge: true }); // merge = it won't override the collection (database)
